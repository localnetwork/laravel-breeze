<div class="flex mb-[50px] flex-wrap justify-between">
    <h1 class="text-[40px] leading-[32px] font-medium text-gray-900">Withdraw Cordo points</h1>
...
<x-splade-form id="withdrawalForm" 
    confirm
    ...
    <div id="step-2" class="step bg-[#f3f3f3] p-[30px] pt-[5px] rounded-[15px] relative">
        ...
        <h2 class="text-[#280031] text-[20px] font-bold pl-[60px] mb-[10px]">Payment Cashout Platform </h2>
    ...
    <div id="step-1" class="step bg-[#f3f3f3] p-[30px] pt-[5px] rounded-[15px] relative">
        ...
        <h2 class="text-[#280031] text-[20px] font-bold pl-[60px] mb-[10px]">Enter your account number </h2>
        <x-splade-input type="text" name="payment_receiver" id="payment_receiver" placeholder="Enter account number" class="form-control" />
    ...
    <div class="flex items-center gap-4"> 
        ...
        <input class="text-[20px] hover:bg-[#0b9749] bg-[#00b14f] py-[15px] px-[30px] rounded-full cursor-pointer text-uppercase text-white max-w-[280px] w-full min-w-[100px] " type="submit" value="Withdraw Now" />
    </div>
</x-splade-form>